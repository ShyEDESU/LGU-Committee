            ...
            <select name="meeting_id"
                ...
                <?php foreach ($meetings as $meeting): ?>
                    <option value="<?php echo $meeting['id']; ?>"
                        data-committee-id="<?php echo $meeting['committee_id']; ?>">
        ...
        <div>
            ...
            <select name="agenda_item_id"
                ...
                <?php foreach ($agendaItems as $item): ?>
                    <option value="<?php echo $item['id']; ?>" data-meeting-id="<?php echo $item['meeting_id']; ?>">
            ...
            <select name="referral_id"
                ...
                <?php foreach ($referrals as $referral): ?>
                    <option value="<?php echo $referral['id']; ?>"
                        data-committee-id="<?php echo $referral['committee_id']; ?>">
