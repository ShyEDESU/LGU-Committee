    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-4">
            <div class="bg-red-50 border-red-200 border-2 rounded-lg p-3">
                <i class="bi bi-check-square text-red-700 text-2xl"></i>
            </div>
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tasks</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Manage and view all tasks in your system.</p>
            </div>
        </div>
    </div>
    ...
    <div class="border-b border-gray-200 dark:border-gray-700 mb-8 sticky top-0 bg-white dark:bg-gray-900 z-10">
        <nav class="flex gap-4 overflow-x-auto" role="tablist">
            <button
                ...
                id="all-tasks-tab"
                aria-selected="true"
                onclick="switchTab('all-tasks', 'Tasks')"
            ...
            <button
                ...
                aria-selected="false"
                onclick="switchTab('assigned-to-me', 'Tasks')"
            ...
            <button
                ...
                id="completed-tab"
                aria-selected="false"
                onclick="switchTab('completed', 'Tasks')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                Completed
            </button>
            <button
                ...
                id="overdue-tab"
                aria-selected="false"
                onclick="switchTab('overdue', 'Tasks')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                Overdue
            </button>
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Completed</h2>
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">This section is ready for content implementation.</p>
                </div>
            </div>
