...
<head>
    ...
    <title>Schedule Meeting - CMS</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-2">Schedule a Meeting</h2>
            <p class="text-gray-600 mb-6">Create a new committee meeting</p>
            <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
                <form class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600">
                    </div>
                    <div class="flex gap-4 pt-4">
                        <button type="submit" class="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700">Schedule</button>
                    </div>
                </form>
            </div>
        </div>
