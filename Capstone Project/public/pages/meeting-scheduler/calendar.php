...
<body class="bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-2">Calendar View</h2>
            <p class="text-gray-600 mb-6">View meetings in calendar format</p>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-center h-64 text-center">
                    <div><i class="fas fa-calendar text-6xl text-gray-300 mb-4"></i>
                    <p class="text-gray-500 text-lg">Calendar will appear here</p></div>
                </div>
            </div>
        </div>
    </div>
