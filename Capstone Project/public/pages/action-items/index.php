...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'add') {
        ModuleDataHelper::addItem($module_key, [
            'title' => $_POST['title'] ?? 'New Action Item',
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-4">
            <div class="bg-red-50 border-red-200 border-2 rounded-lg p-3">
                <i class="bi bi-list-task text-red-700 text-2xl"></i>
            </div>
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Action Items</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Manage and view all action items in your system.</p>
            </div>
        </div>
    </div>

    <!-- Tabs Navigation -->
    <div class="border-b border-gray-200 dark:border-gray-700 mb-8 sticky top-0 bg-white dark:bg-gray-800 z-10">
        <nav class="flex gap-4 overflow-x-auto" role="tablist">
            <button
                role="tab"
                id="all-items-tab"
                aria-selected="true"
                onclick="switchTab('all-items', 'Action Items')"
            ...
            <button
                ...
                aria-selected="false"
                onclick="switchTab('assigned-to-me', 'Action Items')"
            ...
            <button
                ...
                id="overdue-tab"
                aria-selected="false"
                onclick="switchTab('overdue', 'Action Items')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                Overdue
            </button>
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Assigned to Me</h2>
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Overdue</h2>
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">This section is ready for content implementation.</p>
                </div>
            </div>
