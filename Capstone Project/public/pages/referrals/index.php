    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-4">
            <div class="bg-red-50 border-red-200 border-2 rounded-lg p-3">
                <i class="bi bi-send text-red-700 text-2xl"></i>
            </div>
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Referrals</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Manage and view all referrals in your system.</p>
            </div>
        </div>
    </div>
    ...
    <div class="border-b border-gray-200 dark:border-gray-700 mb-8 sticky top-0 bg-white dark:bg-gray-900 z-10">
        <nav class="flex gap-4 overflow-x-auto" role="tablist">
            <button
                ...
                id="outgoing-tab"
                aria-selected="true"
                onclick="switchTab('outgoing', 'Referrals')"
            ...
            <button
                ...
                id="tracking-tab"
                aria-selected="false"
                onclick="switchTab('tracking', 'Referrals')"
            ...
            <button
                ...
                id="history-tab"
                aria-selected="false"
                onclick="switchTab('history', 'Referrals')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                History
            </button>
            <button
                ...
                id="reports-tab"
                aria-selected="false"
                onclick="switchTab('reports', 'Referrals')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                Reports
            </button>
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Outgoing</h2>
