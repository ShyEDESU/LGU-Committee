...
// Map settings, preserving existing branding if not provided
$data = [
    ...
    'session_timeout' => $input['session_timeout'] ?? $currentSettings['session_timeout'],
    'min_password_length' => $input['min_password_length'] ?? $currentSettings['min_password_length'],
    ...
    'smtp_port' => $input['smtp_port'] ?? $currentSettings['smtp_port'],
    'smtp_user' => $input['smtp_user'] ?? $currentSettings['smtp_user'],
    'smtp_pass' => $input['smtp_pass'] ?? $currentSettings['smtp_pass'],
    'smtp_encryption' => $input['smtp_encryption'] ?? $currentSettings['smtp_encryption'],
    'log_retention_days' => $input['log_retention_days'] ?? $currentSettings['log_retention_days'],
