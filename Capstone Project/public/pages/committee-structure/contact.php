...
<head>
    ...
    <title>Contact Information - CMS</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            <div class="mb-6">
                ...
                <p class="text-gray-600 mt-1">View committee contact details and representatives</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-center h-64 text-center">
                    <div>
                        ...
                        <p class="text-gray-500 text-lg">Contact information will appear here</p>
                    </div>
                </div>
            </div>
        </div>
