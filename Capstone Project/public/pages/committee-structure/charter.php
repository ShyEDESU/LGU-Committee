...
<body class="bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            <div class="mb-6">
                <h2 class="text-3xl font-bold text-gray-800">Charter & Rules</h2>
                <p class="text-gray-600 mt-1">Manage committee charters and operational rules</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-center h-64 text-center">
                    <div>
                        ...
                        <p class="text-gray-500 text-lg">Charter documents will appear here</p>
                    </div>
                </div>
            </div>
        </div>
