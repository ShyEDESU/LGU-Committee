...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Member Assignment</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Manage and view all member assignment in your system.</p>
            </div>
        </div>
    </div>
    ...
    <div class="border-b border-gray-200 dark:border-gray-700 mb-8 sticky top-0 bg-white dark:bg-gray-900 z-10">
        <nav class="flex gap-4 overflow-x-auto" role="tablist">
            <button
                ...
                id="directory-tab"
                aria-selected="true"
                onclick="switchTab('directory', 'Member Assignment')"
            ...
            <button
                role="tab"
                id="assign-members-tab"
                aria-selected="false"
                onclick="switchTab('assign-members', 'Member Assignment')"
            ...
            <button
                ...
                id="roles-tab"
                aria-selected="false"
                onclick="switchTab('roles', 'Member Assignment')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                Roles
            </button>
            <button
                ...
                id="substitutes-tab"
                aria-selected="false"
                onclick="switchTab('substitutes', 'Member Assignment')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                Substitutes
            </button>
            <button
                ...
                id="history-tab"
                aria-selected="false"
                onclick="switchTab('history', 'Member Assignment')"
                class="px-4 py-3 font-medium text-sm transition-colors whitespace-nowrap text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white border-b-2 border-transparent"
            >
                History
            </button>
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Directory</h2>
    ...
    <div
        id="assign-members-content"
        role="tabpanel"
        aria-labelledby="assign-members-tab"
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Assign Members</h2>
    ...
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Roles</h2>
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">This section is ready for content implementation.</p>
                </div>
            </div>
    ...
    <div
        id="substitutes-content"
        role="tabpanel"
        aria-labelledby="substitutes-tab"
        class="animate-fadeIn hidden"
    >
        <div class="bg-red-50 dark:bg-gray-800 border-red-200 dark:border-gray-700 border rounded-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Substitutes</h2>
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">This section is ready for content implementation.</p>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const moduleName = 'Member Assignment';
