...
<head>
    ...
    <title>Legal Analysis - CMS</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-2">Legal Analysis</h2>
            <p class="text-gray-600 mb-6">Review legal analysis documents</p>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-center h-64 text-center">
                    ...
                    <p class="text-gray-500 text-lg">Legal analysis will appear here</p></div>
                </div>
            </div>
        </div>
    </div>
