                                    ...
                                    <?php foreach ($itemDelibs as $delib): ?>
                                        <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                            <div class="flex items-start justify-between mb-2">
                                                <div class="flex items-center">
                                                    <i class="bi bi-person-circle text-blue-600 dark:text-blue-400 text-xl mr-2"></i>
...
<?php else: ?>
    <div
        class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
        <i class="bi bi-calendar-event text-6xl text-gray-400 dark:text-gray-500 mb-4"></i>
        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Select a Meeting</h3>
        <p class="text-gray-600 dark:text-gray-400">Choose a meeting above to start tracking deliberations</p>
    </div>
<?php endif; ?>
